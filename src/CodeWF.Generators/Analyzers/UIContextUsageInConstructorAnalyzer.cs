...
namespace CodeWF.Generators.Analyzers;
...
{
    public const string UiContextType = "CodeWF.Models.UI.UiContext";
    public const string UiContextFileSuffix = "_UiContext.cs";
    public const string DialogViewModelBaseType = "CodeWF.ViewModels.Dialogs.Base.DialogViewModelBase<TResult>";
