...
{
    public const string NavigationMetaDataAttributeDisplayString = "CodeWF.NavigationMetaDataAttribute";

    private const string NavigationMetaDataDisplayString = "CodeWF.NavigationMetaData";

    private const string RoutableViewModelDisplayString = "CodeWF.ViewModels.Navigation.RoutableViewModel";
    ...
    private static string? ProcessClass(Compilation compilation, INamedTypeSymbol classSymbol, ISymbol attributeSymbol, ISymbol metadataSymbol)
    {
        ...
        var source = new StringBuilder(
			...
			using CodeWF.ViewModels.Navigation;
