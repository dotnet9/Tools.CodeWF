...
{
    public static readonly StyledProperty<Popup> SearchResultsPopupProperty =
        AvaloniaProperty.Register<TitleBar, Popup>(nameof(SearchResultsPopup));
    ...
    protected override void OnLoaded(RoutedEventArgs e)
    {
        ...
        // TODO
        //SearchResultsPopup = this.GetVisualDescendants().OfType<Popup>()
        //    .First(popup => popup.Name == "SearchResultsPopup");
    }
